...
T::~T() {}
T::T(Grid* gameGrid, int blockid, int lvl, bool ob) : level{lvl}, onBoard{ob} {
  g = gameGrid;
...
void T::updateStates() {
  ...
  vec3.emplace_back(Coordinate{leftRef.row, leftRef.col + 1});
  ...
  vec4.emplace_back(Coordinate{leftRef.row - 1, leftRef.col});
